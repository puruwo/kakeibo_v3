...
| `domain.red` | `#FF7171FF` | 支出（旧pink）。KP-012 でカテゴリー赤は `#F45058` になったが、支出アクセントは据え置き（ユーザー判断 2026-09-10）🔸 |
...
| トークン | light | dark | 置き換え対象 |
|---------|-------|------|------------|
| `color.expense` | `#FF7171FF` 🔸 | `#FF7171FF` | pink(支出用途 21)。KP-012 でも据え置き（カテゴリー1番の赤 `#F45058` とは別値になった） |
...
> 🔸 ライト背景では `#FF7171`（赤・CR 2.7）・`#12C281`（緑・CR 2.3）ともにコントラストが弱い可能性。
