...
/// main.dart と同じ 18 リポジトリ注入。フルページ描画で実リポジトリ（実DB）を使う。
List<Override> repoOverrides() => [
      categoryAccountingRepositoryProvider.overrideWithValue(ImplementsCategoryAccountingRepository()),
      smallCategoryTileRepositoryProvider.overrideWithValue(ImplementsSmallCategoryTileRepository()),
      dailyExpenseRepositoryProvider.overrideWithValue(ImplementsDailyExpenseRepository()),
      aggregationStartMonthRepositoryProvider.overrideWithValue(ImplementsAggregationStartMonthRepository()),
      aggregationStartDayRepositoryProvider.overrideWithValue(ImplementsAggregationStartDayRepository()),
      expenseSmallCategoryRepositoryProvider.overrideWithValue(ImplementsExpenseSmallCategoryRepository()),
      expensebigCategoryRepositoryProvider.overrideWithValue(ImplementsExpenseBigCategoryRepository()),
      incomeBigCategoryRepositoryProvider.overrideWithValue(ImplementsIncomeBigCategoryRepository()),
      incomeSmallCategoryRepositoryProvider.overrideWithValue(ImplementsIncomeSmallCategoryRepository()),
      expenseRepositoryProvider.overrideWithValue(ImplementsExpenseRepository()),
      monthBasisRepositoryProvider.overrideWithValue(ImplementsMonthBasisRepository()),
      yearBasisRepositoryProvider.overrideWithValue(ImplementsYearBasisRepository()),
      budgetRepositoryProvider.overrideWithValue(ImplementsBudgetRepository()),
      incomeRepositoryProvider.overrideWithValue(ImplementsIncomeRepository()),
      fixedCostRepositoryProvider.overrideWithValue(ImplementsFixedCostRepository()),
      batchHistoryRepositoryProvider.overrideWithValue(ImplementsBatchHistoryRepository()),
      fixedCostExpenseRepositoryProvider.overrideWithValue(ImplementsFixedCostExpenseRepository()),
      fixedCostCategoryRepositoryProvider.overrideWithValue(ImplementsFixedCostCategoryRepository()),
    ];
