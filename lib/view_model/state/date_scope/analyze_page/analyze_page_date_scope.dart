...
final analyzePageDateScopeEntityProvider =
    AsyncNotifierProvider<AnalyzePageDateScopeNotifier, DateScopeEntity>(
  AnalyzePageDateScopeNotifier.new,
);

class AnalyzePageDateScopeNotifier extends AsyncNotifier<DateScopeEntity> {
  @override
  Future<DateScopeEntity> build() async {
    // 選択期間を取得する
    final selectedDate = ref.watch(analyzePageSelectedDatetimeNotifierProvider);
    ...
    return DateScopeEntity(
      ...
      aggregationMonthPeriod: monthPeriod,
