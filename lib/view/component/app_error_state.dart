...
/// 背景はベタ塗りしない。空状態（`context.textStyles.listEmptyMessage`・textSecondary）とは
/// 色とアイコンの有無で区別する。
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Row(
        ...
        children: [
          Icon(AppIcons.error, size: 18, color: context.colors.danger),
          const SizedBox(width: AppSpacing.sm),
          Flexible(
            child: Text(message, style: context.textStyles.errorMessage),
          ),
        ],
      ),
    );
