...
part of 'edit_expense_small_category_value.dart';
...
mixin _$EditExpenseSmallCategoryValue {
  ...
  int get displayOrderInBig => throw _privateConstructorUsedError;
  int get defaultDisplayed => throw _privateConstructorUsedError; // 編集後表示順
...
class _$EditExpenseSmallCategoryValueImpl
  ...
  @override
  String toString() {
    return 'EditExpenseSmallCategoryValue(id: $id, bigCategoryKey: $bigCategoryKey, name: $name, smallCategoryOrderKey: $smallCategoryOrderKey, displayOrderInBig: $displayOrderInBig, defaultDisplayed: $defaultDisplayed, editedStateDisplayOrder: $editedStateDisplayOrder, etitedStateIsChecked: $etitedStateIsChecked)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EditExpenseSmallCategoryValueImpl &&
            ...
            (identical(other.displayOrderInBig, displayOrderInBig) ||
                other.displayOrderInBig == displayOrderInBig) &&
