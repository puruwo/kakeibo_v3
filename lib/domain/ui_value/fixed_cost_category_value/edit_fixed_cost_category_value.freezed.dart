...
part of 'edit_fixed_cost_category_value.dart';
...
mixin _$EditFixedCostCategoryValue {
  ...
  int get isDisplayed => throw _privateConstructorUsedError; // 編集後表示順
...
class _$EditFixedCostCategoryValueImpl implements _EditFixedCostCategoryValue {
  ...
  @override
  String toString() {
    return 'EditFixedCostCategoryValue(id: $id, name: $name, colorCode: $colorCode, resourcePath: $resourcePath, displayOrder: $displayOrder, isDisplayed: $isDisplayed, editedStateDisplayOrder: $editedStateDisplayOrder, editedStateIsChecked: $editedStateIsChecked)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EditFixedCostCategoryValueImpl &&
