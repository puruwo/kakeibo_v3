...
abstract class _PredictionGraphValue implements PredictionGraphValue {
  const factory _PredictionGraphValue(
      ...
      required final bool shouldShowIncomeLine}) = _$PredictionGraphValueImpl;
