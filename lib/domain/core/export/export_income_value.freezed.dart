...
part of 'export_income_value.dart';
...
/// @nodoc
class _$ExportIncomeValueCopyWithImpl<$Res, $Val extends ExportIncomeValue>
    implements $ExportIncomeValueCopyWith<$Res> {
  _$ExportIncomeValueCopyWithImpl(this._value, this._then);
...
class _$ExportIncomeValueImpl implements _ExportIncomeValue {
  ...
  @override
  String toString() {
    return 'ExportIncomeValue(id: $id, date: $date, price: $price, memo: $memo, bigCategoryName: $bigCategoryName, bigCategoryId: $bigCategoryId, smallCategoryName: $smallCategoryName, smallCategoryId: $smallCategoryId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ExportIncomeValueImpl &&
