...
mixin _$FixedCostExpenseEntity {
  ...
  /// Serializes this FixedCostExpenseEntity to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FixedCostExpenseEntity
...
abstract class $FixedCostExpenseEntityCopyWith<$Res> {
  factory $FixedCostExpenseEntityCopyWith(
    FixedCostExpenseEntity value,
...
/// @nodoc
class _$FixedCostExpenseEntityCopyWithImpl<
  $Res,
...
class __$$FixedCostExpenseEntityImplCopyWithImpl<$Res>
    extends
        _$FixedCostExpenseEntityCopyWithImpl<$Res, _$FixedCostExpenseEntityImpl>
...
class _$FixedCostExpenseEntityImpl implements _FixedCostExpenseEntity {
  ...
  get copyWith =>
      __$$FixedCostExpenseEntityImplCopyWithImpl<_$FixedCostExpenseEntityImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$FixedCostExpenseEntityImplToJson(this);
  }
}
...
abstract class _FixedCostExpenseEntity implements FixedCostExpenseEntity {
  ...
  String get name;
  @override
  int get confirmedCostType; // 0: 金額確定固定費, 1: 金額未確定固定費
  @override
  int get isConfirmed;
